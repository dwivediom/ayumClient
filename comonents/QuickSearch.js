...
const QuickSearch = () => {
  return (
    <div className={`m-4 grid grid-cols-4 lg:grid-cols-8 gap-2 ${styles.maindiv}`}>  
     <div className='h-12 lg:h-16 rounded-full  border-2 border-red-600 bg-red-400 text-center      pt-3 lg:pt-4  text-white decoration-8'> <span className={`${styles.divtext}`}>Kideny</span> </div>
     ...
     <div className=' h-12 lg:h-16 rounded-full  border-2 border-red-600 bg-pink-400 text-center    pt-3 lg:pt-4  text-white decoration-8'> <span className={`${styles.divtext}`}>Gynae</span> </div>
