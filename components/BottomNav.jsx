...
const BottomNav = () => {
  return (
	...
	<section id="bottom-navigation" className="lg:hidden  gird grid-cols-5   text-white block fixed  inset-x-0 bottom-0 z-10 bg-gray-700 shadow">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 0110.374 21c-2.331 0-4.512-.645-6.374-1.766z" />
			...
			<Link href={'/'}><a className="w-full focus:text-cyan-500 hover:text-cyan-500 text-center justify-center inline-block text-center pt-2 pb-1">
			<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class=" text-center inline w-6  h-6">
